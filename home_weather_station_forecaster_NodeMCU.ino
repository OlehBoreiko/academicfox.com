...
String SendHTML(float temperature, float humidity, float pressure,float altitude, String forecast){
  ...
  ptr +="<meta name='viewport' content='width=device-width, initial-scale=1.0' charset='UTF-8'></meta>";
  ...
  ptr +="</head>";
  ptr +="<body>";
  ptr +="<h1>Домашня метеостанція</h1>";
  ...
  ptr +="</div>";
  ptr +="<div class='side-by-side text'>Вологість</div>";
  ptr +="<div class='side-by-side reading'>";
  ptr +=humidity;
  ...
  ptr +="</div>";
  ptr +="<div class='side-by-side text'>Тиск</div>";
  ptr +="<div class='side-by-side reading'>";
  ptr +=(int)pressure;
  ...
  ptr +="</div>";
  ptr +="<div class='side-by-side text'>Висота</div>";
  ptr +="<div class='side-by-side reading'>";
  ptr +=(int)altitude;
